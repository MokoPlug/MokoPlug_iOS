...
#define backViewHeight (kScreenHeight - defaultTopInset - VirtualHomeHeight)
...
- (instancetype)init{
    if (self = [super init]) {
        ...
        [self setBackgroundColor:COLOR_CLEAR_MACROS];
...
- (UITextField *)textField{
    if (!_textField) {
        ...
        _textField.attributedPlaceholder = [MKAttributedString getAttributedString:@[@"Filter Name"] fonts:@[MKFont(15.f)] colors:@[RGBCOLOR(128, 128, 128)]];
